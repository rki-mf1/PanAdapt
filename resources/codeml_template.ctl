seqfile = stewart.aa           * Path to the alignment file
treefile = stewart.trees          * Path to the tree file
...
NSsites = NSsites_placeholder          * Models for ω varying across sites
